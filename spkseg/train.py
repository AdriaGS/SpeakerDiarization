...
if __name__=="__main__":
    ...
    parser.add_argument('--LSTMactivation', type=str, default='tanh', help='activator to be used at the LSTM')
    parser.add_argument('--LSTMrec_activation', type=str, default='sigmoid', help='recurrent activator to be used at the LSTM')
    parser.add_argument('--GRUactivation', type=str, default='tanh', help='activator to be used at the GRU')
    parser.add_argument('--GRUrec_activation', type=str, default='hard_sigmoid', help='recurrent activator to be used at the GRU')
    parser.add_argument('--optimizer', type=int, default=1, help='Value 1 to use RMSProp, Value 0 to use SGD')
    parser.add_argument('--learning_rateRMS', type=float, default=0.001, help='starting learning rate RMSProp')
    parser.add_argument('--learning_rate_decayRMS', type=float, default=0.0, help='learning rate decay RMSProp')
    parser.add_argument('--rhoRMS', type=float, default=0.9, help='Value rho RMSProp')
    parser.add_argument('--epsilonRMS', type=float, default=1e-8, help='Value epsilon RMSProp')
    # bookkeeping
